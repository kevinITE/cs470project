...
public class X509CertificateGenerator {
    ...
    public static X509Certificate generateCertificate(String dn, PrivateKey signingKey, PublicKey key, int days, String algorithm) throws GeneralSecurityException,IOException {
